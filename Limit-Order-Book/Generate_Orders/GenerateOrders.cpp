...
void GenerateOrders::createOrders(int numberOfOrders)
{
    ...
    file.open("/home/prasoon/Documents/Limit-Order-Book/Limit_order_book/Orders.txt");
...
void GenerateOrders::createInitialOrders(int numberOfOrders, int centreOfBook)
{
    ...
    std::ofstream file("/home/prasoon/Documents/Limit-Order-Book/Limit_order_book/initialOrders.txt");
